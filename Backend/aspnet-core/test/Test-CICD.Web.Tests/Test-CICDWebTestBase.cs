...
{
    public abstract class Test-CICDWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Test-CICDWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Test-CICDWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Test-CICDDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Test-CICDDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Test-CICDDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Test-CICDDbContext, Task<T>> func)
        {
            T result;
